...
class TestMonthlyPaymentBank:
    """Bank loan page: Monthly payment calculate correctly: BUAH-1976"""

    @pytest.mark.regression
    def test_local_user_monthly_payment_calculate_correctly_on_bank_loan_page_after_selecting_property(self):
        ...
        with allure.step("Change \"Down payment\" value"):
            ...
            down_payment_value = bank_loan_page.send_dawn_payment_and_return_data(DataReader.get_data(
                "Monthly Payment Calculation.down payment value"))
