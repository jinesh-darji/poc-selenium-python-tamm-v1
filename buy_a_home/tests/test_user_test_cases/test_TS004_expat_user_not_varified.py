...
from buy_a_home.steps.LogInAsUserSteps import LogInAsUserSteps, EXPAT_USER_NOT_VERIFIED
...
Checks movers companies."""
    ...
    def test_TS004_expat_user_not_varified(self):
        LogInAsUserSteps.login_as_user(EXPAT_USER_NOT_VERIFIED)
    ...
    def other_steps_with_home(self):
        ...
        with allure.step("User can check the steps for applying for water and electricity"):
            print()
        ...
        with allure.step("Close pop-up message"):
